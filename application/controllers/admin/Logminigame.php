...
Class Logminigame extends MY_Controller
{
    ...
    function accounttaixiuajax()
    {
        ...
        $money = $this->input->post("money");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2').'?c=505&rid='.$phientx.'&nn='.$nickname.'&bs='.$cuadat.'&ts='.urlencode($toDate).'&te='.urlencode($fromDate).'&mt='.$money.'&p='.$pages);
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
            echo "Bạn không được hack";
   ...
   function detailphientaixiu(){
    ...
    function detailphientaixiuajax(){
        ...
        $money = $this->input->post("money");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2').'?c=506&nn='.$nickname.'&rid='.$phientx.'&bs='.$cuadat.'&mt='.$money.'&p='.$pages);
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
            echo "Bạn không được hack";
    ...
    function logkhobauajax(){
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2').'?c=122&un='.$nickname.'&rid='.$phienbc.'&bv='.$roomvin.'&ts='.urlencode($toDate).'&te='.urlencode($fromDate).'&p='.$pages.'&gn=KhoBau');
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
            echo "Bạn không được hack";
    ...
    function lognudiepvienajax(){
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2').'?c=122&un='.$nickname.'&rid='.$phienbc.'&bv='.$roomvin.'&ts='.urlencode($toDate).'&te='.urlencode($fromDate).'&p='.$pages.'&gn=NuDiepVien');
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
            echo "Bạn không được hack";
    ...
    function logavengerajax(){
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2').'?c=122&un='.$nickname.'&rid='.$phienbc.'&bv='.$roomvin.'&ts='.urlencode($toDate).'&te='.urlencode($fromDate).'&p='.$pages.'&gn=SieuAnhHung');
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
            echo "Bạn không được hack";
    ...
    function logvuongquocvinajax(){
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2').'?c=122&un='.$nickname.'&rid='.$phienbc.'&bv='.$roomvin.'&ts='.urlencode($toDate).'&te='.urlencode($fromDate).'&p='.$pages.'&gn=VuongQuocVin');
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
            echo "Bạn không được hack";
