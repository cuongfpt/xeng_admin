...
Class Report extends MY_Controller
{
    ...
    function  cashoutbybankajax()
    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=112&nn=' . $nickname . '&b=' . $bank . '&st=' . "" . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&tid=' . $tranid);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
    ...
    function  cashoutbycardajax()
    {
        ...
        $tranid = urlencode($this->input->post("tranid"));
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=113&nn=' . $nickname . '&pv=' . $provider . '&sp=' . $serial . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&tid=' . $tranid.'&pa='.$partner);
    ...
    function  cashoutbytopupajax()
    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=114&nn=' . $nickname . '&tg=' . $mobile . '&st=' . "" . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&tid=' . $tranid.'&pa='.$partner.'&type='.$type);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargebyvincardajax()
    {
        ...
        $pages = $this->input->post("pages");
        $tranid = urlencode($this->input->post("tranid"));
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=500&nn=' . $nickname . '&pv=&sr=' . $serial . '&pn=' . $mathe . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&tid=' . $tranid);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargebycardajax()
    {
        ...
        $pages = $this->input->post("pages");
        $tranid = urlencode($this->input->post("tranid"));
        $datainfo = $this->curl->simple_get($this->config->item('api_backend2') . '?c=115&nn=' . $nickname . '&pv=' . $provider . '&sr=' . $serial . '&pn=' . $mathe . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&tid=' . $tranid);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  doisoattheajax()
    {
        ...
        $fromDate = $this->input->post("fromDate");
        $provider = $this->input->post("provider");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=161&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate).'&cr='.$provider);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargebybankajax()
    {
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=720&nn=' . $nickname . '&tid=' . $txtvinplay . '&ip=' . $txtip . '&b=' . $bank . '&st=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&tno=' . "" . '&p=' . $pages);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargebynganluongajax()
    {
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=721&nn=' . $nickname . '&tid=' . $txtvinplay . '&ip=' . $txtip . '&b=' . $bank . '&st=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&tno=' . "" . '&p=' . $pages);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  logsmsotpajax()
    {
        ...
        $pages = $this->input->post("pages");
        $tranid = urlencode($this->input->post("tranid"));
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=722&m=' . $mobile . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&rid=' . $tranid);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  logbrandnameajax()
    {
        ...
        $pages = $this->input->post("pages");
        $tranid = urlencode($this->input->post("tranid"));
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=719&m=' . $mobile . '&co=' . "" . '&st=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&rid=' . $tranid);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  moneysystemajax()
    {
        ...
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend') . '?c=7&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  moneytotalajax()
    {
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=9&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargebyiapajax()
    {
        ...
        $fromDate = $this->input->post("fromDate");
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=124&nn=' . $nickname . '&am=' . $provider . '&oid=' . $txtoderid . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargeby9029ajax()
    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=315&nn=' . $nickname . '&m=' . $mobile . '&am=' . $amout . '&rid=' . $rid . '&co=' . $status . '&ts=' . $toDate . '&te=' . $fromDate . '&p=' . $pages);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargeby8x98ajax()
    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=314&nn=' . $nickname . '&m=' . $mobile . '&am=' . $amout . '&sc=' . $shortcode . '&rid=' . $rid . '&co=' . $status . '&ts=' . $toDate . '&te=' . $fromDate . '&p=' . $pages);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  checkmo9029ajax()
    {
        ...
        $fromDate = urlencode($this->input->post("fromDate"));
        $pages = $this->input->post("pages");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=316&m=' . $mobile . '&am=' . $amout . '&co=' . $status . '&ts=' . $toDate . '&te=' . $fromDate . '&p=' . $pages);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  reportupdatecardajax()
    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=510&nn=' . $nickname . '&pv=' . $provider . '&sr=' . $serial . '&pn=' . $mathe . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&rid=' . $tranid . '&act=' . $txtnickname);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function doisoatnganluongajax()
    {
        ...
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=511&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function doisoatvmgajax()
    {
        ...
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=18&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
...

    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=18&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time));
    ...
    function doisoatbrandnameajax()
    {
        ...
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=19&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
...

    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=19&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time));
    ...
    function doisoatmuamtajax()
    {
        ...
        $fromDate = $this->input->post("fromDate");
        $partner = $this->input->post("partner");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=146&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&pa=' . $partner);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function doisoatnapdtajax()
    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=147&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&pa=' . $partner . '&type=' . $dichvu);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function doisoat9029ajax()
    {
        ...
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=149&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
...

    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=149&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time));
    ...
    function  exportbycard()
    {
        ...
        if ($table == 1) {
            ...
            $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=152&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time) . '&am=' . $amount . '&co=' . $code);
        } else if ($table == 3) {
            $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=153&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time) . '&am=' . $amount . '&co=' . $code);
        }
        else if ($table == 4) {
            $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=158&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time) . '&am=' . $amount . '&co=' . $code.'&pa='.$partner.'&pv='.$provider);
        } else if ($table == 5) {
            $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=159&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time) . '&am=' . $amount . '&co=' . $code.'&pa='.$partner.'&pv='.$provider.'&type='.$type);
        }

        else if ($table == 6) {
            $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=165&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time) . '&pri=' . $amount);
        }
    ...
    function doisoat8x98ajax()
    {
        ...
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=148&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
...

    {
        ...
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=148&ts=' . urlencode($start_time) . '&te=' . urlencode($end_time));
        $data = json_decode($datainfo)->moneyReponse[1]->trans;
        $data1 = json_decode($datainfo)->moneyReponse[3]->trans;
        $data2 = json_decode($datainfo)->moneyReponse[2]->trans;
    ...
    function doisoatvincardajax()
    {
        ...
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=150&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargebymegacardajax()
    {
        ...
        $pages = $this->input->post("pages");
        $tranid = urlencode($this->input->post("tranid"));
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=514&nn=' . $nickname . '&pv=&sr=' . $serial . '&pn=' . $mathe . '&co=' . $status . '&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&tid=' . $tranid);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function doisoatmegacardajax()
    {
        $toDate = $this->input->post("toDate");
        $fromDate = $this->input->post("fromDate");
        $datainfo = $this->get_data_curl($this->config->item('api_backend2') . '?c=515&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate));
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
    ...
    function  rechargefromvtcajax()
    {
        ...
        $status= urlencode($this->input->post("status"));
        $datainfo = $this->curl->simple_get($this->config->item('api_backend2') . '?c=163&nn=' . $nickname .'&ts=' . urlencode($toDate) . '&te=' . urlencode($fromDate) . '&p=' . $pages . '&tid=' . $tranid.'&pri='.$price.'&st='.$status);
        if (isset($datainfo)) {
            echo $datainfo;
        } else {
            echo "Bạn không được hack";
